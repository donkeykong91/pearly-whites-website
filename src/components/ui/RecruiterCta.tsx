...
const RecruiterCta = () => {
  return (
    <a
      ...
      className="from-bossanova-700 to-bossanova-600 hover:to-bossanova-500 shadow-bossanova-600/40 hover:shadow-bossanova-600/55 fixed right-4 bottom-4 z-50 inline-flex items-center rounded-full bg-gradient-to-r px-5 py-3 text-sm font-semibold tracking-wide text-white shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl sm:right-6 sm:bottom-6 sm:text-base"
    >
      Email for Interview
    </a>
  );
